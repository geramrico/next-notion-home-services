        ...
        <section className="block">
          <div className="overflow-hidden rounded-lg border bg-background shadow p-4">
            <p className="text-base text-gray-700">
              ...
              Encontrar prestadores de servicios es dificil. En Google la
              informacion esta desactualizada, no atienden, o no son de
              confianza.
            </p>
            <p className="mt-4 text-base text-gray-700">
              Por eso cree este proyecto, donde puedes encontrar servicios que
